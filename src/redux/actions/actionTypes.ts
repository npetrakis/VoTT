...
export enum ActionTypes {
    ...
    SAVE_SAS_SUCCESS = "SAVE_SAS_SUCCESS",
    ...
    SAVE_CONNECTIONS_SUCCESS = "SAVE_CONNECTIONS_SUCCESS",
    SAVE_CONNECTION_PROJECT_STATUS_SUCCESS = "SAVE_CONNECTION_PROJECT_STATUS_SUCCESS",
    FETCH_CONNECTIONS_SUCCESS = "FETCH_CONNECTIONS_SUCCESS",
    FETCH_CONNECTION_PROJECT_STATUSES_SUCCESS = "FETCH_CONNECTION_PROJECT_STATUSES_SUCCESS",
